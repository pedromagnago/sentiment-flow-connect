...
import { ReportsPage as PDFReportsTab } from '@/components/reports/ReportsPage';
import { 
  BarChart, 
  Bar, 
  PieChart, 
  ...
  return (
    <div className="container mx-auto p-6 space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Análise de métricas e geração de documentos
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="ai" className="space-y-4">
        <TabsList>
          <TabsTrigger value="ai">Relatórios de IA</TabsTrigger>
          <TabsTrigger value="pdf">Gerar PDFs</TabsTrigger>
        </TabsList>
